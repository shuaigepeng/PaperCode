...
def set_uav_param(uav_id):
    ...
    # 当前速度
    parser.add_argument('--current_speed', type=list, default=[random.uniform(-1, 1)*10, random.uniform(-1, 1)*10, random.uniform(-1, 1)*10], help='speed of uav at current time')
    # 当前位置
